...
const category = ["한식","찌개/탕/찜","중식","일식","양식","간식","면요리","기타"]
const foodName = [
                ["갈비","게장","곱창","김치볶음밥","껍데기","닭갈비","닭발","떡갈비","보쌈","불고기",
                      "비빔밥","삼겹살","생선구이","수제비","오징어볶음","육회","전","제육볶음","족발","죽",
                      "찜닭","조개구이"],
                ["김치찌개","설렁탕","떡국","갈비찜","순두부찌개","닭도리탕","매운탕","삼계탕","감자탕","뼈해장국",
                      "육개장","국밥","추어탕","갈비탕","백숙","부대찌개","된장찌개","청국장","아귀찜",],
                ["깐쇼새우","깐풍기","마라탕","마파두부","볶음밥","양꼬치","양장피","짜장면","짬뽕",
                    "탕수육","훠궈"],
                ["낫토","돈까스","라멘","메밀소바","샤브샤브","연어덮밥","초밥","회"],
                ["리조또","샐러드","스파게티","크림파스타","피자","함박스테이크","햄버거","치킨"],
                ["김밥","닭강정","도시락","떡볶이","만두","밥버거","샌드위치","순대","쫄면","컵밥","핫도그"],
                ["냉면","막국수","비빔국수","쌀국수","잔치국수","칼국수","콩국수","우동"],
                ["카레","월남쌈"]
]
  ...
  for(let i=0;i<category.length;i++){
    for(let j=0;j<foodName[i].length;j++){
        try{
            ...
            database().ref(`/Food/${foodName[i][j]}`).update({
                id: count,
                name : foodName[i][j],
                url : res,
                catagori : category[i],
